...
- 一些[[编译器]]并未实现[[实例化单元]]（也称为[[模板库]]或[[模板注册表]]），而是在 [阶段7](((655afacb-82dd-4390-86ad-f073d7faca44))) 简单地编译每个[[模板实例化]]，将代码存储在 隐式 或 显式 请求它的 对象文件 中，然后[[链接器]]在 [阶段9](((655afacb-457a-4813-a946-9d879858f81b))) 将这些 编译好的实例化 合并为一个。
-